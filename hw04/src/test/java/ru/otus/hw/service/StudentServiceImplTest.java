...
class StudentServiceImplTest {
    ...
    public void init() {
        ...
        when(ioService.readStringWithPromptLocalized(contains("first"))).thenReturn(expectedFirstName);
        when(ioService.readStringWithPromptLocalized(contains("last"))).thenReturn(expectedLastName);
